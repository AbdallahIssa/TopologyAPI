...
/**
 * Here we have the attributes for the topologies In the Memory ,file paths ,methods that implement the API and some Helper methods
 * <p>
 * <b>Note:</b> You will use this class in Main class
 * </p>
...
public class ElectronicDevice {
     ...
     */
    protected String readJsonFileAsString(String file) throws Exception {
        return new String(Files.readAllBytes(Paths.get(file)));
    }

    /**
     * write the topology to JSON file.
     *
     * @param topology           topology.
     * @param newFilePath        new File Path.
     */
    protected void writeTopologyToJsonFile(Topology topology, String newFilePath) throws IOException {
        if (topology != null)
     ...
     *
     * @param topologyID        topology ID.
     * @return the topology by its id.
     */
    protected Topology getTopologyById(String topologyID) {
